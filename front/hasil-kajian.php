...
<style>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="tab-content active" id="content-tab1">
              ...
              <select id="filterName1">
                  ...
                  <?php
                    ...
                    //$url =$_SERVER['DOCUMENT_ROOT'].'/data/data1.json';
              ...
              <table id="myTable1" class="display" data-current-category="">
                  ...
                  <tbody>
                      <?php
                        ...
                        //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data2.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab2">
              ...
              <select id="filterName2">
                  ...
                  <?php
                    ...
                    //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data3.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable2" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data4.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab3">
              ...
              <select id="filterName3">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data5.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable3" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data6.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab4">
              ...
              <select id="filterName4">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data7.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable4" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data8.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab5">
              ...
              <select id="filterName5">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data9.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable5" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data10.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab6">
              ...
              <select id="filterName6">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data11.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable6" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data12.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab7">
              ...
              <select id="filterName7">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data13.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
                  ...
                  <tbody>
                      <?php
                       $url = 'https://standarpangan.pom.go.id/apisabo/getpesanan.php?nil=5930d4943514964&cid=b7';
                        //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data14.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab8">
              ...
              <select id="filterName8">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data15.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable8" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data16.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab9">
              ...
              <select id="filterName9">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data17.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable9" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url =$_SERVER['DOCUMENT_ROOT']. '/data/data18.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab10">
              ...
              <select id="filterName10">
                  ...
                  <?php
                    ...
                    //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data19.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable10" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data20.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab11">
              ...
              <select id="filterName11">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data21.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable11" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data22.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab12">
              ...
              <select id="filterName12">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data23.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable12" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data24.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab13">
              ...
              <select id="filterName13">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data25.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable13" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data26.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
            ...
            <div class="tab-content" id="content-tab14">
              ...
              <select id="filterName14">
                  ...
                  //$url = $_SERVER['DOCUMENT_ROOT'].'/data/data27.json';
                    $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                    $response = file_get_contents($url, false, $context);
              ...
              <table id="myTable14" class="display" data-current-category="">
                  ...
                  <tbody>
                      ...
                      //$url =$_SERVER['DOCUMENT_ROOT']. '/data/data28.json';
                        $context = stream_context_create(['ssl' => ['verify_peer' => false, 'verify_peer_name' => false]]);
                        $response = file_get_contents($url, false, $context);
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 footer-links">
            <p><img style="height: 100px !important;" src="/assets/img/Footer.svg" alt="" class="img-fluid"></p>
            <div class="social-links mt-3">
              <a href="#" class="instagram"><img class="grayscale grayscale-fade" src="/assets/img/instagram.svg" alt="Instagram" width="100%"></a>
              <a href="#" class="facebook"><img class="grayscale grayscale-fade" src="/assets/img/facebook.svg" alt="facebook" width="100%"></a>
              <a href="#" class="youtube"><img class="grayscale grayscale-fade" src="/assets/img/youtube.svg" alt="youtube" width="100%"></a>
              <a href="#" class="spotify"><img class="grayscale grayscale-fade" src="/assets/img/spotify.svg" alt="spotify" width="100%"></a>
              <a href="#" class="spotify"><img style="height: 36px;" src="/assets/img/Space Logo.png"></i></a>
            </div>
          </div>
  ...
  <div class="buttonkurawa"> <a target="_blank" href="https://kusapa.pom.go.id/transkrip/"> <img id="idgambar"
        src="/assets/img/livechat.png" alt="Helpline Sobat Repa" style="max-height:120px; "></a> </div>
  <p></p>
</div>
