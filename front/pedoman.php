...
<h1>Pedoman <input type="text" class="form-control pull-right" name="" style="height: 42px;" placeholder="Cari"></h1>
  </div>
  ...
  <div class="row" id="newsList">
    ...
    <div class="col-sm-3" style="padding: 4px;">
      <div class="col-sm-12 pedoman">
        <img src="/assets/pedoman/Pedoman (1)-<?= $i<10?'0'.$i:$i ?>.jpg">
        <span>Pedoma <?= $i ?></span><br>
        <span>2024</span>
      </div>
    </div>
  <?php } ?>
