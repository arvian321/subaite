...
<style>
  ...
  .news-details {
    ...
    margin: 5;
    padding-top: 0;
    /* Menghapus padding atas agar margin atas juga bisa terlihat */
  ...
  @media (max-width: 768px) {
    ...
    .news-details {
      ...
      /* Warna latar belakang */
      font-size: 12px;
      /* Mengatur ukuran font menjadi 24px */
      font-family: 'Poppins', sans-serif;
      /* Menggunakan jenis font Poppins */
      font-weight: bold;
      /* Membuat teks tombol menjadi tebal */
    }
  }
</style>
  ...
  <main id="main">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        <h2 style="color: #0b1ea0; text-align: center; ">Booklet</h2>
        <!-- Kolom Pencarian -->
  ...
  <script>
    ...
    function tampilkanBerita(beritaArr) {
      ...
      beritaArr.forEach(function(berita, index) {
        ...
        judulBerita.addEventListener('mouseleave', function() {
          judulBerita.style.color =
          ''; // Mengembalikan warna tulisan ke semula setelah kursor meninggalkan judul berita
        });
      });
    }
    ...
    document.getElementById('search-btn').addEventListener('click', function() {
      ...
      const filteredBerita = berita.filter(function(berita) {
        return berita.judul.toLowerCase().includes(searchTerm) || berita.ringkasan.toLowerCase().includes(
          searchTerm);
      });
